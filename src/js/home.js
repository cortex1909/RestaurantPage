...
const homePage = () => {
  ...
  const workingTimeContainerAppend = workingTimeContainer()
  const locationContainerAppend = locationContainer()
  content.appendChild(titleContainerAppend)
  content.appendChild(workingTimeContainerAppend)
  content.appendChild(locationContainerAppend)
}
